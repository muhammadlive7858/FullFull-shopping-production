...
<div class="row g-3 d-flex justify-content-between align-center form-control m-1 header-mazza" action="">
    ...
    <div class="col-md-5 d-flex aling-center justify-content-between row">
        ...
        <form action="{{route('create_vaqtincha')}}" class="d-flex justify-content-between w-100 col-6" method="post">
            @csrf
            @method('post')
...
<div class="row">
    <div class="col-10" style="min-width:350px">
        <form action="{{ route('hisoblash') }}" method="">
            ...
            <form action="{{ route('fullhisob') }}" method="post">
                ...
                <div>
                    ...
                    <label class="w-100 d-flex justify-content-between">
                        ...
                        <input type="number" name="history_summa" class="form-control w-25 m-1" placeholder="Summani kiriting:">
                    </label>
                    <label class="w-100 d-flex justify-content-between">
                        <h4>Qarz to'lash vaqti:</h4>
                        <input type="date" name="date" class="form-control w-25 m-1">
                    </label>
                </div>
                <div class="d-flex">
                    ...
                    <a href="{{route('tozalash')}}" id="btd" style="background-color:red;" class="btn btn-danger w-50 mx-1"><i class="bi bi-trash fs-2"></i></a>
                </div>
            </form>
        </div>
        <!--</div>-->
...
<script>
    let btn = querySelector('#animation')
